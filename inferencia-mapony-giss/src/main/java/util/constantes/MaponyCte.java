...
public final class MaponyCte {
	...
	public static final String MSG_NO_DATOS = "No existen datos a procesar en el directorio especificado";
	public static final String MSG_FIN_PROCESO = "Procesado de datos finalizado";

	public static final String getMsgFinJob(final String jobName) {
		return "\nJob " + jobName + " finalizado con ̩xito\n";
	}
