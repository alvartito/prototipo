...
//						.endObject()
//						.startObject("properties")
//							.startObject(MaponyCte.userTagsObject)
//								.field("type", "string")
//								.field("store", "true")
//								.field("index", "analyzed")
//								.field("ignore_above", 500)
//							.endObject()
//							.startObject(MaponyCte.machineTagsObject)
//								.field("type", "string")
//								.field("store", "true")
//								.field("index", "analyzed")
//								.field("ignore_above", 500)
//							.endObject()
//							.startObject(MaponyCte.descripcionObject)
//								.field("type", "string")
//								.field("store", "true")
//								.field("index", "analyzed")
//								.field("ignore_above", 200)
//							.endObject()
//							.startObject(MaponyCte.fotoObject)
//								.field("type", "string")
//								.field("store", true)
//								.field("index", "not_analyzed")
//								.field("include_in_all", false)
//							.endObject()
//							.startObject(MaponyCte.idObject)
//								.field("type", "string")
//								.field("store", true)
//								.field("index", "not_analyzed")
//								.field("include_in_all",false)
//							.endObject()
//							.startObject(MaponyCte.tituloObject)
//								.field("type", "string")
//								.field("store", true)
//								.field("index", "analyzed")
//							.endObject()
//							.startObject(MaponyCte.ciudadObject)
//								.field("type", "string")
//								.field("store", true)
//								.field("index", "analyzed")
//							.endObject()
//							.startObject(MaponyCte.locationObject)
//								.field("type", "geo_point")
//								.field("geohash", true)
//								.field("geohash_prefix", true)
//								.field("include_in_all", false)
