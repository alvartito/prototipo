...
public class MaponyInferenciaJobSinArrayWritable extends Configured implements Tool {

	private static Properties properties;
	private static String indexES;
	private static String typeES;
	private static String clusterName;
	private static final Logger logger = LoggerFactory.getLogger(MaponyInferenciaJobSinArrayWritable.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MaponyInferenciaJobSinArrayWritable.class);
		...
		MultipleInputs.addInputPath(job, pathOrigen, SequenceFileInputFormat.class, MaponyInferenciaMapSinArrayWritable.class);
//		MultipleInputs.addInputPath(job, pathOrigen, TextInputFormat.class, MaponyInferenciaMap.class);
	...
	public static void main(final String args[]) throws Exception {
		...
		ToolRunner.run(new MaponyInferenciaJobSinArrayWritable(), args);
		System.exit(1);
	}
