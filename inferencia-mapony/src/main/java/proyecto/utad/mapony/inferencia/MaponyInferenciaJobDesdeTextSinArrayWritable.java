...
import proyecto.utad.mapony.inferencia.map.MaponyInferenciaMapSinArrayWritable;
...
public class MaponyInferenciaJobDesdeTextSinArrayWritable extends Configured implements Tool {

	private static Properties properties;
	private static String indexES;
	private static String typeES;
	private static String clusterName;
	private static final Logger logger = LoggerFactory.getLogger(MaponyInferenciaJobDesdeTextSinArrayWritable.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MaponyInferenciaJobDesdeTextSinArrayWritable.class);
		...
		MultipleInputs.addInputPath(job, pathOrigen, TextInputFormat.class, MaponyInferenciaMapSinArrayWritable.class);
//		MultipleInputs.addInputPath(job, pathOrigen, TextInputFormat.class, MaponyInferenciaMap.class);
	...
	public static void main(final String args[]) throws Exception {
		...
		ToolRunner.run(new MaponyInferenciaJobDesdeTextSinArrayWritable(), args);
		System.exit(1);
	}
