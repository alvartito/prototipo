...
public class MaponyGroupNearJobSinArrayWritable extends Configured implements Tool {

	private static Properties properties;
	private static final Logger logger = LoggerFactory.getLogger(MaponyGroupNearJobSinArrayWritable.class);
...
//		setRutaFicheros(properties.getProperty(MaponyCte.datos));
		...
		job.setJarByClass(MaponyGroupNearJobSinArrayWritable.class);
...
//		MultipleInputs.addInputPath(job, new Path("data/yfcc100m_dataset-9.bz2"), TextInputFormat.class, MaponyGroupNearMap.class);
	...
	public static void main(String args[]) throws Exception {
		...
		ToolRunner.run(new MaponyGroupNearJobSinArrayWritable(), args);
		System.exit(1);
